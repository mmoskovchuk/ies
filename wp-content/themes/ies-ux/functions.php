...
function ox_adding_scripts() {
    ...
    if( !is_admin() && !is_login_page()) {
        ...
        /*social-likes.js*/
        wp_enqueue_script('social-likes-js', '//cdn.jsdelivr.net/npm/social-likes/dist/social-likes.min.js', array('jquery'), null, true);
        ...
        /*social-likes css*/
        wp_enqueue_style('social-likes-css',  '//cdn.jsdelivr.net/npm/social-likes/dist/social-likes_birman.css', array(), null);
        /*bootstrap*/
        ...
        if (!is_page(array('', ''))) {
            ...
            /*custom css*/
            wp_enqueue_style('custom', get_template_directory_uri() . '/css/style.min.css', array('bootstrap'), null);

            /*plugins css*/
            wp_enqueue_style('plugins', get_template_directory_uri() . '/css/plugins.min.css', array(), null, 'none');
        }
