...
$redirects = [
    ...
    ['/news/','/not-now', 301],
    /*sidebar menu*/
    ['/istoriia-ta-sohodennia/','/not-now', 301],
    ['/zahalna-struktura-instytutu/','/not-now', 301],
    ['/polozhennia-pro-instytut/','/not-now', 301],
    ...
    ['/naukova-robota/','/not-now', 301],
    ['/navchalna-robota/','/not-now', 301],
    ['/metodychna-robota/','/not-now', 301],
    ['/vykhovna-robota/','/not-now', 301],
    ['/rektorskyi-kontrol-iakosti/','/not-now', 301],
